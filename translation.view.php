<?php
    ...
    class translationView extends translation {
        ...
        function dispTranslationIndex() {
			...
			$projectList = $oTransModel->getProjectList($this->module_info->module_srl,$obj);
			$project_list = array();
		...
		function dispTranslationProjectList() {
			...
			if($member_srl){
				...
				$projectList =  $oTransModel->getProjectList($obj->module_srl,$obj);
			}
		...
		function dispTranslationFileList() {
			...
			$fileList = $oTransModel->getProFile($obj, $listCount, $page, $this->pageCount);
